  ...
  <div id="main">
    ...
    <div id="menubar">
      <ul id="menu">
        ...
        <li><a class="current" href="index_1col_bottom.php" title="1 Column - Bottom">1 Column - bottom</a></li>
        <li><a href="index_1col_top.php" title="1 Column - Top">1 Column - Top</a></li>
      </ul>
      <div id="search">
    ...
    <div id="site_content">
      ...
      <div id="content">
        <h1>Welcome to the abstract_05 template</h1>
        <!-- **** INSERT PAGE CONTENT HERE **** -->
        <p>
          This simple 2 column, fixed width website template comes with 4 different
          layouts and is configured for use with <a href="http://snewscms.com/">
          sNews</a>, a lightweight, simple CMS.
        </p>
        <p>
          ...
          Attribution 2.5</a>), which means that you are free to download and
        ...
        <h4>Links</h4>
        <p><a href="index.php">this is an example link</a></p>
        <h4>Block Quotes</h4>
        <blockquote>
          <p>
        ...
        <span class="left"><img src="style/music.jpg" alt="example graphic" /></span>
        <p>
        ...
        <span class="center"><img src="style/music.jpg" alt="example graphic" /></span>
        <span class="right"><img src="style/music.jpg" alt="example graphic" /></span>
        <p>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
          incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
          exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute
